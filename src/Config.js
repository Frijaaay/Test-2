...
const Config = {
  ...
  getStakeholderEmail() {
    return PropertiesService.getScriptProperties().getProperty('FINAL_NOTIF_CC_EMAIL') || 'cortez2nd.jrc2+bryan@gmail.com';
  },
  ...
  getAuthUrl() {
    const props = PropertiesService.getScriptProperties();
    return props.getProperty('ENV') === 'dev' ? props.getProperty('AUTH_DEV') : props.getProperty('AUTH_LIVE');
  },
